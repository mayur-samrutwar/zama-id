  ...
  return (
    <Layout>
      <PageHeader
        ...
        actions={<Link href="/attestations/new" className="inline-flex items-center rounded-md bg-zinc-900 px-3 py-2 text-sm font-medium text-white hover:bg-zinc-800">Issue Attestation</Link>}
      />
